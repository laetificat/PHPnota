...
class Mobile_Detect {
    ...
    protected $phoneDevices = array(     
            ...
            'Samsung' => 'Samsung|GT-P1000|SGH-T959D|GT-I9([0-9]{3})',
            'Sony' => 'E10i',
            'Asus' => 'Asus.*Galaxy',
    ...
    protected $tabletDevices = array(
        ...
        /*'Archos' => '80G9',*/
        'GenericTablet' => 'Tablet|Archos|ViewPad7|LG\-V909|MID7015|BNTV250A|LogicPD Zoom2|\bA7EB\b|CatNova8|A1_07|CT704|CT1002|\bM721\b',
    );
    ...
    protected $userAgents = array(      
      'Chrome' => '\bCrMo\b',
      'Dolfin' => 'Dolfin',
      'Opera' => '(Opera Mini|Opera Mobi)|Opera Tablet',  
      'Skyfire' => 'skyfire',      
      'IE' => 'ie*mobile',
    ...
    function __construct(){
        ...
        if (!empty($_SERVER['HTTP_X_OPERAMINI_PHONE_UA'])) {
          $this->userAgent = $_SERVER['HTTP_USER_AGENT']. "" . $_SERVER['HTTP_X_OPERAMINI_PHONE_UA'];
        } else {
